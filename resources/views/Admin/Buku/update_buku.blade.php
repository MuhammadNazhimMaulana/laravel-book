        ...
        <div class="col-lg-8">
            <form action="/buku/update/{{ $book->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_buku" class="form-control @error('judul_buku') is-invalid @enderror" id="judul_buku" placeholder="Ex Rintik Seduh ..." value="{{ old('judul_buku', $book->judul_buku) }}">
                    @error('judul_buku')
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="penulisId">
                        @foreach ($writers as $writer)
                            @if(old('penulisId', $book->penulisId) == $writer->id)
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="genreId">
                        @foreach ($genres as $genre)
                            @if(old('genreId', $book->genreId) == $genre->id)
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="hargaId">
                        @foreach ($prizes as $harga)
                            @if(old('hargaId', $book->hargaId) == $harga->id)
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_publikasi" class="form-control @error('tanggal_publikasi') is-invalid @enderror" id="tanggal_publikasi" placeholder="Ex Horror ..." value="{{ old('tanggal_publikasi', $book->tanggal_publikasi) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="fotoBukuLama" value="{{ $book->foto_buku }}">
                    {{-- Check If picture exist --}}
                    @if($book->foto_buku)
                        <img src="{{ asset('storage/' . $book->foto_buku) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                    @else
